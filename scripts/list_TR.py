...
import list_TR.locusworkflow
# import list_TR.motifworkflow


def initialize_parser():
    parser = argparse.ArgumentParser(
        prog="list_TR", description="List TRs from STR profiles"
    )
    return parser
...
def add_locus_command(subparsers):
    ...
    help = "TSV file with list of TRs"
...
def run_locus_workflow(args):
    ...
    list_TR.locusworkflow.run(params)
